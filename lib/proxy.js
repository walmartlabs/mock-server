var cookieMonster = require('./cookieMonster').cookieMonster,
    cors = require('./cors'),
    url = require("url");

exports.apiHost = process.env.PHOENIX_API_HOST || 'mobile-e2.walmart.com';

exports.standalone = process.env.PHOENIX_API_HOST_STANDALONE;
exports.proxyPort = exports.standalone ? 8081 : 80;
exports.secureProxyPort = exports.standalone ? 8083 : 443;

exports.logTrace = process.env.PHOENIX_PROXY_TRACE;
if (exports.logTrace === "false") exports.logTrace = false;
exports.logTracePrefix = process.env.PHOENIX_PROXY_TRACE_PREFIX;
var fs = require('fs');
...
exports.proxy = function(secure) {
  ...
  return function(req, res) {
    var href = url.parse(req.url),
        options = {
            method: req.method,
            host: exports.apiHost,
            port: secure ? exports.secureProxyPort : exports.proxyPort,
    ...
    var sourceReq = http.request(options, function(sourceRes) {
        ...
        sourceRes.on("end", function() {
            ...
            if (exports.logTrace) {
              ...
              var fd = fs.openSync((exports.logTracePrefix || 'log') + "/" + fileName, "w");
